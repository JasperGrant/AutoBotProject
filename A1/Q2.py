...
while not button.any():
    ...
    target_angles = [0, 45, 20, 60, 0]  # Adjust these values to your desired angles

    # Set the motor to each target angle in sequence
    for angle in target_angles:
        # Set the motor position to the current angle
        servo.on_to_position(10, angle)

        # Wait until the motor reaches the target angle
